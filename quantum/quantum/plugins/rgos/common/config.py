...
#===================================================================================================
# switch_opts = [
#    cfg.StrOpt('remote_switch_ip', default='192.168.21.35'),
#    cfg.IntOpt('ssh_max_retries', default=-1),
#    cfg.IntOpt('reconnect_interval', default=2),
#    cfg.IntOpt('ssh_port', default=22),
#    cfg.StrOpt('remote_switch_user', default='rj'),
#    cfg.StrOpt('remote_switch_pass', default='rj'),
# ]
#===================================================================================================

switch_opts = [
    cfg.IntOpt('remote_switch_cnt', default=1),
